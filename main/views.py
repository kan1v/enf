...
from .models import Categoty, Product, Size
...
class IndexView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['categories'] = Categoty.objects.all()
...
class CatalogView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if category_slug:
            current_categoty = get_object_or_404(Categoty, slug=category_slug)
